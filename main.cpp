// A C++ Program to Play Minesweeper Made By Kunal Raut.
...
void chooseDifficultyLevel ()
{
    ...
    "Press 1 for BEGINNER (4 * 4 Cells and 8 Mines)\n"
    "Press 2 for INTERMEDIATE (6 * 6 Cells and 20 Mines)\n"
    "Press 3 for ADVANCED (10 * 10 Cells and 30 Mines)\n";
    cin>>level;
